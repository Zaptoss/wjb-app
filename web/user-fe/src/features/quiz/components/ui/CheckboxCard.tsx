  ...
  return (
    ...
    >
      ...
      {(icon || imageUrl) && (
        ...
        >
          {imageUrl ? (
            <img src={imageUrl} alt="" className="w-6 h-6 object-contain" loading="lazy" />
          ) : (
            icon
          )}
        </div>
      ...
      <div
        className={cn(
          'relative z-[1] w-6 h-6 rounded-lg border-2 flex items-center justify-center shrink-0 transition-all duration-300',
